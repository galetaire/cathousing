...
All content is original and can be reproduced as long as it is conveniently credited. You can contact me via twitter, [@Galetaire](https://twitter.com/Galetaire). This website has been built using [Github](https://github.com/), [Vercel](https://vercel.com), [Next.js](https://nextjs.org/) and [Handshake](https://handshake.org/).
