...
which refers to Spain (zone 2 on the map). The information presented could also be used to get a very general picture of the housing situation
...
The production of the charts is based on multiple contrasted statistical institutions (INE, Idescat ...). These charts are reproducible and can be verified by consulting the following sources:
