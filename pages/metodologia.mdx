...
The statistical information presented in the graphs refers to Catalonia (zone 1 of the map). The only exception is the wage information,
...
- Housing proces according to the notaries (Grup 5, Acte 501): [Link](http://www.notariado.org/liferay/web/cien/estadisticas-al-completo)
- Housing price according to _Sociedad de Tasación_: [Link](https://www.st-tasacion.es/informe-de-tendencias-digital/)
...
You can contact me via twitter, [@Galetaire](https://twitter.com/Galetaire) 🍪. This website is built by using [Github](https://github.com/), [Vercel](https://vercel.com), [Next.js](https://nextjs.org/) and [Handshake](https://handshake.org/).
