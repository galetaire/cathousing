...
The statistical information presented on this website refers to Catalonia (map, zone 1). Data from broad Spain (map, zone 2) can be consulted in [spainhousing.galetaire](http://spainhousing.galetaire/) (please, note is a handshake address).
