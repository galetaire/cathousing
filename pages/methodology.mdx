...
The statistical information presented on this website refers to Catalonia (map, zone 1). The only exception is the wage information, which
refers to Spain (map, zone 2). Although it relies only on Catalonia data, the information serves too as a good picture of the housing
market in Spain. Data from broad Spain or other Spanish regions is available upon request.
