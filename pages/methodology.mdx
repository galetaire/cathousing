...
The statistical information presented on this website refers to Catalonia.
The total market cap of the Catalan Real Estate is ~725.855.633.440 euros:

| **Market Cap** | **(Sa × Fp) + (Hp × Ha × D)** |
| ---------- | ------------------------------------------ |
| Catalonia total area (Sa) | 32.108.000.000 m² |
| Average farm land price (Fp) | 1,19 eu/m² |
| Average housing price (Hp) | 1813 eu/m² |
| Average housing area (Ha) | 96 m² |
| Number of dwellings (D) | 3.950.905 |

Data from broad Spain can be consulted on [spainhousing.xyz](https://spainhousing.xyz/).
