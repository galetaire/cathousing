...
The statistical information presented on this website refers to Catalonia (map, zone 1). Still, it serves as a good picture of the Spanish
housing market too (map, zone 2). In this sense, data from broad Spain and other Spanish regions are available upon request.
